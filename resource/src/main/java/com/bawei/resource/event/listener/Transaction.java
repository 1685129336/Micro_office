package com.bawei.resource.event.listener;
...
import com.bawei.resource.event.api.IEvent;
...
public class Transaction {
    ...
    public static void onClick(View view, IEvent.OnClickListener listener) {
